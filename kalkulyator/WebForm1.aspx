<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm1.aspx.cs" Inherits="kalkulyator.WebForm1" %>
...
<body>
    <form id="form1" runat="server">
        <div style="text-align: center">
           <br />
         <asp:TextBox ID="TextBox" runat="server"  Width="110px"></asp:TextBox> 
